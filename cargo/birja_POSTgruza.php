...
if(LANG=='ru') $tt = 'Добавить посылку';

if(LANG=='ro') $tt = 'Adaugarea parcelei';

if(LANG=='en') $tt = 'Add parcel';
...
echo '<div class="modal-content">
			...
			include (dirname(__FILE__)."/addPostCargoFrom.php");
			echo'</div>
			</div>
		  </div>';?></div></div>
...
if(LANG=='ru') $tt = 'Добавить транспорт для посылок';

if(LANG=='ro') $tt = 'Adaugarea transportului pentru parcele';

if(LANG=='en') $tt = 'Add transport for parcels';
...
echo '<div class="modal-content">
			...
			<div class="modal-body">';
			include (dirname(__FILE__)."/addPostTransportFrom.php");
			echo'</div>
			</div>
		  </div>';?></div></div>
...

{
	...
	$.post(home_url+'cargo/birja_postgruzaPost.php', {country_from:From,country_to:To,transport_type:Type},function(data){
