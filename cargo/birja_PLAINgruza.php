...
return $n;
	...
	$query = "SELECT * FROM `movers_cargo`  WHERE `hidden`='0' ";
	$AutoID = '43';
	$query.=" AND `type` IN (".$AutoID.") ";
...

{
	...
	$.post(home_url+'cargo/birja_plaingruzaPost.php', {country_from:From,country_to:To},function(data){
