...
if(LANG=='ru') $tt = 'Разместить заказы пассажиров';

if(LANG=='ro') $tt = 'Adaugarea transportării';

if(LANG=='en') $tt = 'Add transportation';
...
echo '<div class="modal-content">
			...
			include (dirname(__FILE__)."/addPassengerCargoFrom.php");
			echo'</div>
			</div>
		  </div>';?></div></div>
...
if(LANG=='ru') $tt = 'Добавить транспорт для пассажирских перевозок';

if(LANG=='ro') $tt = 'Adaugarea transportului de pasageri';

if(LANG=='en') $tt = 'Add transport for Passenger Transportation';
...
echo '<div class="modal-content">
			...
			<div class="modal-body">';
			include (dirname(__FILE__)."/addPassengerTransportFrom.php");
			echo'</div>
			</div>
		  </div>';?></div></div>
...

{
	...
	$.post(home_url+'cargo/birja_passengergruzaPost.php', {country_from:From,country_to:To,transport_type:Type},function(data){
