...
?>"><img src="<?php echo $tmpTools->baseurl(); ?>/templates/ja_mesolite/images/logo.png" /></a><span style="margin-left:20px;margin-top:30px;position:relative;float:left;font-size:20px;">Moldova Truck - Сайт транспортных экспедиторских услуг&nbsp;&nbsp;&nbsp;<span style="color: #1076a8">+373 69 107 853</span></span>
				</div>
...
function updateSelect (selectId, optValue, fs)
{
	...
	xmlHttp.onreadystatechange = function()
	{
		...
		{		//alert(xmlHttp.status);
				...
				updateinput(fs, "delete");
				sid.options[sid.options.length] = new Option("--- не имеет значения ---", 0, false, false);
				sid.options[sid.options.length] = new Option("--- другой город ---", 0, false, false);
...
<h1><?php if($mosConfig_lang == 'russian') { echo "Расчитать стоимость перевозки"; }
...
?> <span style="color: red">*</span>
	...
	<select type="select" name="cargo_type" size="1"  style="width: 220px" id="cargo_type">
			<?php if($mosConfig_lang == 'russian') { echo '<option value="">- укажите тип груза -</option>';}
...
<!--   заказ транспорта  -->
<h1><?php if($mosConfig_lang == 'russian') { echo "Заказать транспорт"; }
...
<!--   заказ транспорта  END  -->
							<?/*
							<h3>Реклама:</h3>
							<a title="Международные грузоперевозки, поиск грузов и транспорта" href="http://www.com-stil.com">
