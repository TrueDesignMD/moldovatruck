...
if (isset($_SESSION['user'])&&$_SESSION['group']=='admin') $_SESSION['s'] = '1';
if(!empty($_GET['route'])) { 
...
if (empty($_GET['route'])) require("add_news.php");
/*
if ($arr[0]=='add_news') require("add_news.php");
if ($arr[0]=='add_page') require("add_page.php");
if ($arr[0]=='edit_news') require("edit_news.php");
if ($arr[0]=='edit_page') require("edit_page.php");
if ($arr[0]=='edit_menu') include("edit_menu.php");
if ($arr[0]=='add_menu') include("add_menu.php");
if ($arr[0]=='security') include("security.php");
if ($arr[0]=='dell_page'&&!empty($arr[1])&&is_numeric($arr[1])) include("dell_page.php");
if ($arr[0]=='dell_menu'&&!empty($arr[1])&&is_numeric($arr[1])) include("dell_menu.php");
if ($arr[0]=='menu_top'&&!empty($arr[1])&&is_numeric($arr[1])) include("change_menu.php");
if ($arr[0]=='menu_down'&&!empty($arr[1])&&is_numeric($arr[1])) include("change_menu.php");
*/
